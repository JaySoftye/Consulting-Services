    ...
    <div class="row parallax-first">
      <div class="col nopadding">
        ...
        <div class="card vid-button">
          ...
          <img src="public/images/Teq_Consulting_Services_network-enabled-intro-vid.jpg" class="full" alt="Teq Consulting Services" />
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container-fluid nedm-dark-bg padding-bottom parallax-third">
      <div class="row">
        <div class="container padding-top">
          ...
          <br />
          <h4 class="white">From there you can choose which of our Consulting services plans that fits your needs. It all starts with a general, but indepth survey. Although this survey <strong>will only take 5-10 minutes of your time, it can save your District hundreds in the long run</strong>.</h3>
        </div>
      </div>
    </div>
