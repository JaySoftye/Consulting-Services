...
<main class="main-content">
  ...
  <section>
    ...
    <div class="container-fluid brochure leadership parallax-second">
      <div class="container">
        <div class="row padding-top">
          <div class="col-md-6">
            ...
            <p><button type="button" class="button leadership-button" data-toggle="modal" data-target="#brochureform">Request a brochure</button></p>
          </div>
        </div>
      </div>
    </div>
