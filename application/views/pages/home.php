...
<section class="container-fluid nopadding header-container">
  <div class="top-header">
    ...
    <video poster="" playsinline autoplay muted loop>
      <source src="/consulting-services/public/images/consulting-video-clouds-background.webm" type="video/webm" />
      <source src="/consulting-services/public/images/consulting-video-clouds-background.mp4" type="video/mp4" />
    </video>
  </div>
      ...
      <div class="card">
        <div class="row align-items-center consulting-services-intro-container">
          <div class="col-md nopadding">
            <video poster="/consulting-services/public/images/consulting-services-intro-damian-ceo.jpg" playsinline autoplay muted loop>
              <source src="/consulting-services/public/images/consulting-services-intro-ceo.webm" type="video/webm" />
              <source src="/consulting-services/public/images/consulting-services-intro-ceo.mp4" type="video/mp4" />
            </video>
            <div class="container row consulting-services-intro-content">
              <div class="col-md-9 consulting-services-intro">
                ...
                <h1><img src="/consulting-services/public/images/Consulting_Services_damain-scarfo-ceo-sig.jpg" /></h1>
  ...
  <div class="container">
    <div class="row padding-top">
      <div class="col-sm-4 col-padding">
        <img src="/consulting-services/public/images/ConsultingServices_leadership-icon.svg" class="full padding-top" />
      ...
      <div class="col-sm-4 col-padding">
        <img src="/consulting-services/public/images/ConsultingServices_network-enabled-icon.svg" class="full padding-top" />
        <article class="home-col-sections">
        ...
        <a href="/consulting-services/nedm"><button class="button nedm-button">Learn more</button></a>
      </div>
      <div class="col-sm-4 col-padding">
        <img src="/consulting-services/public/images/ConsultingServices_stem-icon.svg" class="full padding-top" />
        <article class="home-col-sections">
