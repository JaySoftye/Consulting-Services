...
<main class="main-content">
  ...
  <div class="container-fluid header-container">
    ...
    <div class="container-fluid gray-bg parallax-second">
    ...
    <div class="container-fluid nedm-bg">
      <div class="container">
        ...
        <div class="row padding-top">
          <div class="col">
            <h1 class="display-4"><strong>Still need help?</strong><br />Let's get started.</h1>
          </div>
        </div>
        ...
        <div class="row padding-top">
          <div class="col-md">
            <h2 class="nedm-text text-center"><strong>Start Today</strong></h2>
